...
Claude Code 的循环之所以复杂，是因为它要同时服务很多场景：交互式终端、被脚本调用、被编辑器驱动、协调子任务、对接各种外部能力……每多服务一个场景，循环里就要多一层状态、多一种结束原因、多一组要测试的情况。这套复杂度对它是值得的，因为它是一个成熟的、面向大量用户的产品。
...
> 想深入到实现细节，见姊妹篇《Claude Code 内核解剖》第 1 章。
